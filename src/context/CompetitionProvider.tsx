...
export const CompetitionProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  // --- Checks user status against our Airtable API ---
  ...
  // --- Registers a new user via our Airtable API ---
  ...
  // --- Updates the user's logo count via our Airtable API ---
  const updateProgress = async (newCount: number) => {
    ...
    // --- Check for completion and fire webhook ---
  ...
  // --- This is the function called when a logo is clicked ---
