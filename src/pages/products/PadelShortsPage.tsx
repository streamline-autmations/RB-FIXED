...
const PadelShortsPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);

  const title = 'Padel Shorts';
  const description = 'Lightweight and flexible shorts offering complete freedom of movement. Includes an elastic waistband for a secure fit during fast-paced games.';
  
  const images = [
    { src: '/padel-shorts-frontback.png', alt: 'Padel Shorts Front and Back View' },
    { src: '/padel-shorts-design-guide.png', alt: 'Padel Shorts Design Guide' }
  ];
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <ul className="space-y-2 text-rb-gray-300">
                  <li>• Ultra-lightweight material for speed.</li>
                  <li>• Secure and comfortable elastic waistband.</li>
                  <li>• Durable construction for sliding and diving.</li>
                </ul>
              </motion.div>
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              { title: 'Padel Golfer', image: '/padel-golfer-frontback.png', path: '/products/padel-golfer' },
...
export default PadelShortsPage;
