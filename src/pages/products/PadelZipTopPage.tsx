...
const PadelZipTopPage: React.FC = () => {
  const [currentImageIndex, setCurrentImageIndex] = useState(0);

  const title = 'Padel Zip Top';
  const description = 'The ideal layering piece for warm-ups or cooler days. This long-sleeve zip top provides warmth without sacrificing breathability.';
  
  const images = [
    { src: '/padel-zip-top-frontback.png', alt: 'Padel Zip Top Front and Back View' },
    { src: '/padel-zip-top-design-guide.png', alt: 'Padel Zip Top Design Guide' }
  ];
...
export default PadelZipTopPage;
